...
export type ListAgentTimelineResponse = JsonResponse<paths["/api/agent-sessions/{session_id}/timeline"]["get"]>;
export type ListAgentTimelineParams = QueryParameters<paths["/api/agent-sessions/{session_id}/timeline"]["get"]>;
...
export type AgentTimelineItem = NonNullable<ListAgentTimelineResponse["data"]>["items"][number];
export type AgentTimelineUserMessageItem = components["schemas"]["AgentTimelineUserMessageItem"];
export type AgentTimelineTurnBoundaryItem = components["schemas"]["AgentTimelineTurnBoundaryItem"];
export type AgentTimelineThinkingItem = components["schemas"]["AgentTimelineThinkingItem"];
export type AgentTimelineTextItem = components["schemas"]["AgentTimelineTextItem"];
export type AgentTimelineToolItem = components["schemas"]["AgentTimelineToolItem"];
export type AgentTimelineSubagentItem = components["schemas"]["AgentTimelineSubagentItem"];
export type AgentTimelineErrorItem = components["schemas"]["AgentTimelineErrorItem"];
export type AgentTimelineReportAttachment = components["schemas"]["AgentTimelineReportAttachment"];
export type AgentStreamFrame = components["schemas"]["AgentStreamFrameSchema"];
