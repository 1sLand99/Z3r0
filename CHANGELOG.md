...
- Reframed public documentation, landing metadata, and interface labels around intelligent, multi-agent security assessment for authorized penetration testing, vulnerability discovery, and technical research; expanded authorization, data-handling, stop-condition, and responsibility notices; and consolidated the documentation site to English.
...
- Added work project attack-path graphing with assets, findings, validation steps, and auditable record snapshots.
...
- Repositioned README and landing copy around intelligent, multi-agent security assessment research and controlled workflows.
...
- Multi-agent security assessment workbench with coordinator and specialist agents for vulnerability discovery, code audit, asset intelligence, authorized validation, reverse engineering, and cryptography review.
